      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {[
          ...
          <div key={card.label} className="soft-card p-5 flex items-center gap-4 bg-white/70 backdrop-blur-xl border border-white/40 hover:translate-y-[-2px] transition-all">
            ...
            <div>
              <p className="text-[13px] font-semibold text-slate-400 uppercase tracking-wider">{card.label}</p>
      ...
      {showForm && (
        <div className="soft-card p-8 mb-10 bg-white/80 backdrop-blur-2xl border border-white/50 shadow-xl shadow-slate-200/50">
          ...
          <form onSubmit={handleAdd} className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            <div>
              <label className="text-[13px] font-medium text-slate-600 block mb-1">Tipo</label>
            ...
            <div>
              <label className="text-[13px] font-medium text-slate-600 block mb-1">Valor (R$)</label>
            ...
            <div>
              <label className="text-[13px] font-medium text-slate-600 block mb-1">Categoria</label>
            ...
            <div>
              <label className="text-[13px] font-medium text-slate-600 block mb-1">Método Pagamento</label>
            ...
            <div>
              <label className="text-[13px] font-medium text-slate-600 block mb-1">Vencimento (1ª pcela)</label>
            ...
            <div>
              <label className="text-[13px] font-medium text-slate-600 block mb-1">Parcelas</label>
            ...
            <div>
              <label className="text-[13px] font-medium text-slate-600 block mb-1">Status Inicial</label>
              <NativeSelect 
                value={form.status} 
            ...
            <div className="flex flex-col justify-end">
               <label className="text-[13px] font-medium text-slate-600 block mb-1">Nota Fiscal / Anexo</label>
               <input 
                 type="file" 
                 ref={fileInputRef} 
                 className="hidden" 
                  ...
                  <div key={r.id} className="group flex items-center gap-5 py-4 px-6 hover:bg-white/60 transition-all border-b border-slate-50 last:border-0">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-3 mt-1 text-slate-400">
                        <span className="text-[13px] font-medium uppercase tracking-tight">{r.category}</span>
                        <span className="w-1 h-1 rounded-full bg-slate-200"></span>
                        <span className="text-[13px]">{r.payment_method}</span>
                        {r.due_date && (
                          <>
                            <span className="w-1 h-1 rounded-full bg-slate-200"></span>
                            <span className="text-[13px] font-medium">Vence {new Date(r.due_date).toLocaleDateString('pt-BR')}</span>
                          </>
                        )}
                        {r.invoice_url && (
                          <>
                    ...
                    <div className="flex-shrink-0 flex items-center gap-3">
                      <NativeSelect 
                        ...
                        className={cn(
                          "w-[110px] text-[13px] font-bold uppercase tracking-wider h-8 bg-transparent border-slate-200",
